 ...
 * @param {bigint} fee_per_gram
 * @returns {any}
 */
export function build_commitment_transaction(commitment_hex, utxos_json, change_address, fee_per_gram) {
    ...
    const ret = wasm.build_commitment_transaction(ptr0, len0, ptr1, len1, ptr2, len2, fee_per_gram);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function build_pending_proof(digest_hex, nonce_hex) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_pending_proof(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {Uint8Array} pending_proof_bytes
 * @param {string} attestation_json
 * @returns {Uint8Array}
 */
export function complete_proof(pending_proof_bytes, attestation_json) {
    const ptr0 = passArray8ToWasm0(pending_proof_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(attestation_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.complete_proof(ptr0, len0, ptr1, len1);
    if (ret[3]) {
...
export function compute_sha256(data) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compute_sha256(ptr0, len0);
 ...
 * @returns {string}
 */
export function compute_sha256_hex(data) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.compute_sha256_hex(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function create_commitment(nonce_hex, hash_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.create_commitment(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @param {string} signed_tx_json
 * @returns {string}
 */
export function create_submit_tx_rpc_request(signed_tx_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(signed_tx_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.create_submit_tx_rpc_request(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {bigint}
 */
export function get_commitment_burn_amount() {
    const ret = wasm.get_commitment_burn_amount();
 ...
 * @returns {string}
 */
export function get_wallet_address(private_key_hex, network) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.get_wallet_address(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {any}
 */
export function get_wallet_info(private_key_hex, network) {
    const ptr0 = passStringToWasm0(private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_wallet_info(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {boolean}
 */
export function is_valid_proof_format(proof_bytes) {
    const ptr0 = passArray8ToWasm0(proof_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.is_valid_proof_format(ptr0, len0);
    return ret !== 0;
}
 ...
 * @returns {any}
 */
export function parse_proof(proof_bytes) {
    const ptr0 = passArray8ToWasm0(proof_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_proof(ptr0, len0);
    return ret;
}
 ...
 * @param {any} proof_json
 * @returns {Uint8Array}
 */
export function serialize_proof_to_bytes(proof_json) {
    const ret = wasm.serialize_proof_to_bytes(proof_json);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {any}
 */
export function sign_transaction(unsigned_tx_json, utxos_json, private_key_hex, network) {
    const ptr0 = passStringToWasm0(unsigned_tx_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(utxos_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ptr3 = passStringToWasm0(network, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.sign_transaction(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {boolean}
 */
export function validate_private_key(private_key_hex) {
    const ptr0 = passStringToWasm0(private_key_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_private_key(ptr0, len0);
    return ret !== 0;
}
 ...
 * @returns {any}
 */
export function verify_proof(proof_bytes, data) {
    const ptr0 = passArray8ToWasm0(proof_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ktcs_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
